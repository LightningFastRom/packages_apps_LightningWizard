...
package org.lightningfastrom.setupwizard.tests;
...
public class ManualTestActivity extends Activity {
    ...
    private void enableSetup() {
        try {
            ...
            resetComponentSets("org.lightningfastrom.setupwizard", GET_ACTIVITIES |
    ...
    private void setSetupComplete() {
        ...
        Intent intent = new Intent("android.intent.action.MAIN");
        intent.addCategory("android.intent.category.HOME");
        disableComponentSets("org.lightningfastrom.setupwizard",  GET_ACTIVITIES |
